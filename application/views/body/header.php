...
<head>
    ...
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/assets2/css/style.css">
    <!-- END: Custom CSS-->
...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-shopping-cart"></i><span class="badge badge-pill badge-success badge-up cart-item-count">6</span></a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-cart dropdown-menu-right">
                                ...
                                <li class="scrollable-container media-list"><a class="cart-item" href="app-ecommerce-details.html">
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="<?= base_url() ?>assets/images/pages/eCommerce/4.png" width="75" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="<?= base_url() ?>assets/images/pages/eCommerce/dell-inspirion.jpg" width="100" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="<?= base_url() ?>assets/images/pages/eCommerce/7.png" width="88" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img src="<?= base_url() ?>assets/images/pages/eCommerce/10.png" width="75" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="<?= base_url() ?>assets/images/pages/eCommerce/sony-75class-tv.jpg" width="100" alt="Cart Item"></div>
                                        ...
                                        <div class="media">
                                            <div class="media-left d-flex justify-content-center align-items-center"><img class="mt-1 pl-50" src="<?= base_url() ?>assets/images/pages/eCommerce/canon-camera.jpg" width="70" alt="Cart Item"></div>
                                ...
                                <li class="dropdown-menu-footer"><a class="dropdown-item p-1 text-center text-success" href="app-ecommerce-checkout.html"><i class="feather icon-shopping-cart align-middle"></i><span class="align-middle text-bold-600">Checkout</span></a></li>
                                <li class="empty-cart d-none p-2">Your Cart Is Empty.</li>
                            </ul>
                        </li> -->
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon feather icon-bell"></i><span class="badge badge-pill badge-success badge-up">5</span></a>
                                ...
                                <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)">
                                        <div class="media d-flex align-items-start">
                                            ...
                                            <div class="media-body">
                                                <h6 class="success media-heading">You have new order!</h6><small class="notification-text"> Are your going to meet me tonight?</small>
                                            </div><small>
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"><?= $this->session->userdata('nama_user') ." - ". $this->session->userdata('cabang') ?></span></div><span><img class="round" src="<?= base_url() ?>assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="<?= base_url('kas/logout') ?>"><i class="feather icon-power"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <ul class="main-search-list-defaultlist d-none">
        <li class="d-flex align-items-center"><a class="pb-25" href="#">
                <h6 class="text-success mb-0">Files</h6>
            </a></li>
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
                <div class="d-flex">
                    <div class="mr-50"><img src="<?= base_url() ?>assets/images/icons/xls.png" alt="png" height="32"></div>
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
                <div class="d-flex">
                    <div class="mr-50"><img src="<?= base_url() ?>assets/images/icons/jpg.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
                <div class="d-flex">
                    <div class="mr-50"><img src="<?= base_url() ?>assets/images/icons/pdf.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between w-100" href="#">
                <div class="d-flex">
                    <div class="mr-50"><img src="<?= base_url() ?>assets/images/icons/doc.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="d-flex align-items-center"><a class="pb-25" href="#">
                <h6 class="text-success mb-0">Members</h6>
            </a></li>
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img src="<?= base_url() ?>assets/images/portrait/small/avatar-s-8.jpg" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img src="<?= base_url() ?>assets/images/portrait/small/avatar-s-1.jpg" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img src="<?= base_url() ?>assets/images/portrait/small/avatar-s-14.jpg" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion d-flex align-items-center cursor-pointer"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-50"><img src="<?= base_url() ?>assets/images/portrait/small/avatar-s-6.jpg" alt="png" height="32"></div>
                    <div class="search-data">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url('dashboard') ?>">
                        ...
                        <h2 class="brand-text mb-0">S-LOGISTIK</h2>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
			    <li class="nav-item"><a href="<?= base_url('dashboard')?>"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Email">Dashboard</span></a>
				...
				<li class="nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Ecommerce">Penggajian</span></a>
                    <ul class="menu-content">
                        <li><a href="<?= base_url('gaji/karyawan') ?>"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Karyawan</span></a>
                        </li>
                        <li><a href="<?= base_url('gaji/out') ?>"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">Penggajian</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" navigation-header"><span>Report</span>
                </li>
				<li class=" nav-item"><a href="#"><i class="feather icon-file-text"></i><span class="menu-title" data-i18n="Ecommerce">Laporan</span></a>
                    <ul class="menu-content">
                        <li><a href="<?= base_url('report/masuk') ?>"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Masuk</span></a>
                        </li>
                        <li><a href="<?= base_url('report/keluar') ?>"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">Keluar</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" navigation-header"><span>Data Master</span>
                </li>
				<li class=" nav-item"><a href="#"><i class="feather icon-file-text"></i><span class="menu-title" data-i18n="Ecommerce">Data Master</span></a>
                    <ul class="menu-content">
                        <li><a href="<?= base_url('master/desc-kas-keluar') ?>"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Deskripsi Kas Keluar</span></a>
                        </li>
                        <!-- <li><a href="app-ecommerce-details.html"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Details">Keluar</span></a>
                        </li> -->
                    </ul>
                </li>

                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Data master kas keluar</h4>
                            </div>
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xl-4 col-md-6 col-12 mb-1">
                                            ...
                                            <label class="form-label" for="validationCustom01">Deskripsi</label>
                                                <input type="text" class="form-control" name="deskripsi2" placeholder="Deskripsi">
                                            </fieldset>
                                        </div>
                                        <!-- <div class="col-xl-4 col-md-6 col-12 mb-1">
                                            <fieldset class="form-group">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-xl-4">
                                                <button type="button" id="submit_desc_kas_keluar" class="btn btn-primary">Submit</button>

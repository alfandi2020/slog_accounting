                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <form method="GET" action="<?php echo base_url('report/excel_masuk')?>">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-2">
                                                <select class="form-control" name="months_saldo" id="months_saldo" onchange="this.form.submit()">
                                                    ...
                                                    ?>
                                                    <option <?= isset($bulan_pilih)  ? 'selected' : '' ?> value="<?= $bulan_pilih ?>"><?= $bulan ?></option>
                                                    <option value="" disabled>---</option>
                                            ...
                                            <div class="col-md-2">
                                                <a href="<?= base_url('report/masuk')?>" class="btn btn-primary">Reset</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <p class="mt-1">Total Kas Masuk</p>
                                    <h4 class="text-bold-200">Rp.50.000.000.000</h4>
                                </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <p class="mt-1">Total Kas Keluar</p>
                                    <h4 class="text-bold-200">Rp.24.000.000.000</h4>
                                </div>
                                <div class="card-content">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <p class="mt-1">HPP</p>
                                    <h4 class="text-bold-200">Rp.15.000.000.000</h4>
                                </div>
                                <div class="card-content">
                                            ...
                                            <div class="chat">
                                                <div class="chat-avatar">
                                                    <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                        <img src="<?= base_url() ?>assets/images/portrait/small/avatar-s-2.jpg" alt="avatar" height="40" width="40" />
                                                    </a>
                                                </div>
                                                <div class="chat-body">
                                            ...
                                            <div class="chat chat-left">
                                                <div class="chat-avatar mt-50">
                                                    <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                        <img src="<?= base_url() ?>assets/images/portrait/small/avatar-s-5.jpg" alt="avatar" height="40" width="40" />
                                                    </a>
                                                </div>
                                                <div class="chat-body">
                                                    <div class="chat-content">
